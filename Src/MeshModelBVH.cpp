...
namespace PotatoEngine
{
	...
	glm::vec3 MeshModelBVH::QueryClosestPoint(const glm::vec3& queryPoint, float maxSearchDist) const
	{
		...
		return QueryClosestPointIterate(queryPoint, maxSearchDist * maxSearchDist);
	}
	...
	glm::vec3 MeshModelBVH::QueryClosestPointIterate(const glm::vec3& queryPoint, const float searchDist2) const
	{
		glm::vec3 res(NAN);
		float currentMin2 = FLT_MAX;
